...
void main() {
  group('Form Integration Tests', () {
    ...
    testWidgets('should validate dropdown selections',
      ...
      final countryField = find.byType(DropDownSearchFormField<String>).first;
      await tester.tap(countryField);
      await tester.pumpAndSettle();
      await tester.enterText(countryField, 'InvalidCountry');
      await tester.pumpAndSettle();
      ...
      // Should show validation error for invalid country
      expect(find.text('Please select a valid country'), findsOneWidget);
    });
    ...
    testWidgets('should allow valid form submission',
      ...
      // Select valid city
      final cityField = find.byType(DropDownSearchFormField<String>).last;
    ...
    testWidgets('should reset form correctly', (WidgetTester tester) async {
      ...
      await tester.tap(countryField);
      await tester.pumpAndSettle();
      await tester.enterText(countryField, 'Canada');
      await tester.pumpAndSettle();
      ...
      final countryTextField = tester.widget<TextField>(find.descendant(
        of: countryField,
        matching: find.byType(TextField),
      ));
      expect(countryTextField.controller?.text, isEmpty);
    });
    ...
    testWidgets('should handle dropdown suggestions correctly',
      ...
      await tester.tap(countryField);
      await tester.pumpAndSettle();
      await tester.enterText(countryField, 'U');
      await tester.pumpAndSettle();

      // Should show USA and UK
    ...
    testWidgets('should handle multiple dropdown fields independently',
      ...
      await tester.tap(countryField);
      await tester.pumpAndSettle();
      await tester.enterText(countryField, 'Germany');
      await tester.pumpAndSettle();

      expect(find.text('Germany'), findsOneWidget);

      // Test city dropdown independently
      final cityField = find.byType(DropDownSearchFormField<String>).last;
      await tester.tap(cityField);
      await tester.pumpAndSettle();
